...
public class GyuzActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gyuz2);
        ...
        num1 = intent.getIntExtra("result",0);//메인액티에서가져온 점수
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(rd2.isChecked() == true){
                        num1++;
                        intent1 = new Intent(getApplicationContext(),GyuzActivity3.class);

...
public class GyuzActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gyuz3);
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(rd4.isChecked() == true){
                    num1++;
                    intent1 = new Intent(getApplicationContext(),GyuzActivity4.class);

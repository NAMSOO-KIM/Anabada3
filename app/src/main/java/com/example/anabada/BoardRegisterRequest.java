...
public class BoardRegisterRequest extends StringRequest {
    ...
    public BoardRegisterRequest(String boardTitle, String boardContents, String boardImageurl, Response.Listener<String> listener )throws Exception
    {
        super(Method.POST , URL, listener,null); //URL에 POST 방식(요청을 숨겨서)으로 보내라.
        parameters = new HashMap<>(); //각각의 값을 넣을 수 있게 해쉬맵으로
        para=new HashMap<>();
        //boardImageurl= new byte[]{1, 1, 2, 2, 3, 3, 3};

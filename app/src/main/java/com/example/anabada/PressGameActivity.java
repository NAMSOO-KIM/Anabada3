...
public class PressGameActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pressgame);
    ...
    public class ProgressHandler extends Handler {
        public void handleMessage(Message msg){
            ...
            if(mProgressBar.getProgress() == mProgressBar.getMax()){
                ...
                mTextView_progress.setText("남은시간: "+(100 - mProgressBar.getProgress()));
        }
    } // 남은시간 표시(프로그래스 바)
    ...
    public AlertDialog createDialogBox(){
        ...
        mBuilder.setMessage("점수: "+(100-mProgressBar.getProgress()));
